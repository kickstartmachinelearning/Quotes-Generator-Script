<h1 style="text-align: center;">MOLTIVATIONAL QUOTES GENERATOR APPLICATION</h1><br>
<?php
//////////////////////////////////////////////////////
//
...
//   Powered by: Ebune Joseph
//
//////////////////////////////////////////////////////
$bgcolor = 'lemongreen';
$textcolor = 'lemongreen';
$textsize = '12';
...
<br><br><br>
<a href="" onclick="refresh()" style="width: 150px; height: 50px; border: 2px solid orange; padding: 13px;  background-color: white; color: orange; margin:3% 40%; cursor: pointer;"> GET NEXT QUOTE</a>
